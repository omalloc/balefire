module github.com/omalloc/balefire
...
replace (
	github.com/quic-go/quic-go v0.59.0 => github.com/quic-go/quic-go v0.58.1
	github.com/quic-go/webtransport-go v0.10.0 => github.com/quic-go/webtransport-go v0.9.0
)
